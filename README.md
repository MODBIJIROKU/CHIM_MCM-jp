...
非公式の翻訳パッチです
※一部、誤訳がありましたので、修正版に差し替えました。よろしくお願いいたします 2026.8.22

## 内容

- Scripts/AIAgentMCMConfigScript.pex
- AIAgentMCMConfigScript_pex_english_japanese.xml
...
- Scripts/AIAgentMCMConfigScript.pex は CHIM(AIagent) 3.2.4 専用です。他バージョンには使用しないでください
- どちらか一方の方法で使用してください
